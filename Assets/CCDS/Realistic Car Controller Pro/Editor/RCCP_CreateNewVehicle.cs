...
public class RCCP_CreateNewVehicle {
    ...
    public static RCCP_CarController NewVehicle(GameObject vehicle) {
        ...
        if (EditorUtility.DisplayDialog("Is this a player vehicle, or an AI vehicle?", "Is this a player vehicle, or an AI vehicle? I'm asking because I'll add the 'CCDS_Player' script to the vehicle if it's a player vehicle. AI vehicles shouldn't have this script.", "Yes, it's a player vehicle", "No, it's an AI vehicle")) {

            if (newVehicle.gameObject.GetComponent<CCDS_Player>() == null)
                newVehicle.gameObject.AddComponent<CCDS_Player>();
