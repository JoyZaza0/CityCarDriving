...
public class CCDS_UI_Manager : ACCDS_Manager {
    ...
    public static CCDS_UI_Manager Instance {
        ...
        get {
            ...
            if (instance == null)
                instance = FindObjectOfType<CCDS_UI_Manager>();
    ...
    /// <summary>
    /// In game points panel (drift, stunt, speed).
    /// </summary>
    public GameObject inGamePointsPanel;
    ...
    private void LateUpdate() {
        ...
        if (player) {
            ...
            for (int i = 0; i < movablePanels.Length; i++) {
                ...
                movablePanels[i].anchoredPosition = defaultPositionsOfMovingPanels[i];
                Vector3 localVelocity = player.transform.InverseTransformDirection(player.CarController.Rigid.velocity);
