...
public class CCDS_GameplayManager : ACCDS_Manager {
    ...
    public static CCDS_GameplayManager Instance {
        ...
        get {
            ...
            if (instance == null)
                instance = FindObjectOfType<CCDS_GameplayManager>();
    ...
    public void MissionCompleted(bool success) {
        ...
        if (success) {
            ...
            if (currentMission.missionCompletedInfo != "") {
	            ...
	            MissionPopup.Instance.Setup(currentMission,currentMission.missionCompletedInfo);
            }
	        ...
	        MissionPopup.Instance.Setup(currentMission,currentMission.missionFailedInfo);
        }
        ...
        if (currentMission.gameobjectsToEnable != null && currentMission.gameobjectsToEnable.Length > 0) {
            ...
            for (int i = 0; i < currentMission.gameobjectsToEnable.Length; i++) {
	            ...
	            if (currentMission.gameobjectsToEnable[i] != null && currentMission.gameobjectsToEnable[i].tag != "Track")
