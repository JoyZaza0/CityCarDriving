...
public class CCDS_UI_MainMenuManager : ACCDS_Manager {
    ...
    public static CCDS_UI_MainMenuManager Instance {
        ...
        get {
            ...
            if (instance == null)
                instance = FindObjectOfType<CCDS_UI_MainMenuManager>();
    ...
    private void Update() {
        ...
        if (currentVehicle) {
            ...
            if (vehicleStats_Handling && currentVehicle.Stability)
                vehicleStats_Handling.fillAmount = Mathf.InverseLerp(0f, .6f, (currentVehicle.Stability.tractionHelperStrength + currentVehicle.Stability.steerHelperStrength) * .5f);
            ...
            if (vehicleStats_Handling_Upgraded && currentVehicle.Customizer && currentVehicle.Customizer.UpgradeManager && currentVehicle.Customizer.UpgradeManager.Handling)
                vehicleStats_Handling_Upgraded.fillAmount = Mathf.InverseLerp(0f, .6f, currentVehicle.Customizer.UpgradeManager.Handling.defHandling * currentVehicle.Customizer.UpgradeManager.Handling.efficiency);
    ...
    /// <summary>
    /// Resets save data for testing purposes.
    /// </summary>
