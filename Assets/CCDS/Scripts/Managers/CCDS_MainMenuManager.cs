...
public class CCDS_MainMenuManager : ACCDS_Manager {
    ...
    public static CCDS_MainMenuManager Instance {
        ...
        get {
            ...
            if (instance == null)
                instance = FindObjectOfType<CCDS_MainMenuManager>();
    ...
    public void ClearCart() {
        ...
        CCDS_UI_PurchaseItem[] uI_PurchaseItems = FindObjectsOfType<CCDS_UI_PurchaseItem>(true);

        for (int i = 0; i < uI_PurchaseItems.Length; i++)
            uI_PurchaseItems[i].CheckPurchase();

        //  Updating all upgradable items in the scene.
        CCDS_UI_PurchaseUpgrade[] uI_UpgradeItems = FindObjectsOfType<CCDS_UI_PurchaseUpgrade>(true);
